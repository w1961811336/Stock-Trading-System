...
GO
ALTER TABLE [dbo].[orders]  WITH CHECK ADD  CONSTRAINT [FK_orders_stock] FOREIGN KEY([stock_id])
REFERENCES [dbo].[stock] ([stock_id])
GO
ALTER TABLE [dbo].[transactions]  WITH CHECK ADD  CONSTRAINT [FK_transactions_orders] FOREIGN KEY([sell_order_id])
REFERENCES [dbo].[orders] ([order_id])
GO
ALTER TABLE [dbo].[transactions]  WITH CHECK ADD  CONSTRAINT [FK_transactions_orders1] FOREIGN KEY([buy_order_id])
REFERENCES [dbo].[orders] ([order_id])
GO
ALTER TABLE [dbo].[transactions]  WITH CHECK ADD  CONSTRAINT [FK_transactions_stock] FOREIGN KEY([stock_id])
REFERENCES [dbo].[stock] ([stock_id])
